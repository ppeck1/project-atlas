...
| atlas.workload_snapshot.v1 | DTO schema | `WorkloadSnapshot` | generated on read | no | may contain local paths | Workboard, MCP reads | Cards, grouped counts, actor/risk breakdowns, stale count, review-needed cards, and deterministic next-work suggestions. | 2026-07-04 |
